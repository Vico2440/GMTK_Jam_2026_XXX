...
public class TunaCanMiniGame : MonoBehaviour, IDragHandler, IEndDragHandler 
{
    ...
    private void OnEnable()
    {
        ...
        SoundManager.Instance.PlaySound("CatAngry");
        ...
        if (statusText != null)
        {
            statusText.text = "DRAG TO THE LEFT TO OPEN!";
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        if (currentPhase == Phase.Opening)
        {
            if (eventData.delta.x < 0)
            {
                ...
                {
                    SoundManager.Instance.PlaySound("TunaOpen");
                    TransitionToPouring();
                }
            }
        }
        else if (currentPhase == Phase.Pouring)
        {
            ...
            {
                SoundManager.Instance.PlaySound("TunaDown");
                CompleteMiniGame();
            }
        }
    }
    ...
    private void TransitionToPouring()
    {
        ...
        lidRect.DOAnchorPosY(lidRect.anchoredPosition.y + 300f, 0.4f).SetEase(Ease.InBack)
            .OnComplete(() =>
            {
                ...
                if (statusText != null)
                {
                    statusText.text = "PULL THE CAN DOWN!";
    ...
    private void CompleteMiniGame()
    {
        ...
        if (statusText != null)
        {
            ...
            statusText.text = "THE CAT IS SERVED!";
